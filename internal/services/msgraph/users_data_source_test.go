...
func TestAccUsersDataSource_byUserPrincipalNames(t *testing.T) {
	data := acceptance.BuildTestData(t, "data.azuread_users_msgraph", "test")
...
data "azuread_users_msgraph" "test" {
  user_principal_names = [azuread_user_msgraph.testA.user_principal_name, azuread_user_msgraph.testB.user_principal_name]
}
...
data "azuread_users_msgraph" "test" {
  ...
  user_principal_names = [
    azuread_user_msgraph.testA.user_principal_name,
    azuread_user_msgraph.testB.user_principal_name,
    azuread_user_msgraph.testC.user_principal_name,
...
data "azuread_users_msgraph" "test" {
  object_ids = [azuread_user_msgraph.testA.object_id, azuread_user_msgraph.testB.object_id]
}
`, testAccUser_threeUsersABC(id, password))
}
...
data "azuread_users_msgraph" "test" {
  ...
  object_ids = [
    azuread_user_msgraph.testA.object_id,
    azuread_user_msgraph.testB.object_id,
...
data "azuread_users_msgraph" "test" {
  mail_nicknames = [azuread_user_msgraph.testA.mail_nickname, azuread_user_msgraph.testB.mail_nickname]
}
`, testAccUser_threeUsersABC(id, password))
}
...
data "azuread_users_msgraph" "test" {
  ...
  mail_nicknames = [
    azuread_user_msgraph.testA.mail_nickname,
    azuread_user_msgraph.testB.mail_nickname,
    "not-a-real-user-%d${data.azuread_domains.tenant_domain.domains.0.domain_name}"
  ]
}
`, testAccUser_threeUsersABC(id, password), id)
